...
public class CalenderEx {
	...
	public static void main(String[] args) {
		...
		long dDay = (lastT - nowT) / (1000 * 60 * 60 * 24);		// ms * sec * min * h = day
		...
		birth.set(1995, Calendar.NOVEMBER, 3);		// 내 생일로 날짜 지정하기
		
		long birthD = birth.getTimeInMillis() / (1000 * 60 * 60 * 24);	// 내 생일을 ms 로 반환하고 일 단위로 반환
