...
public class App {
	...
	public static Course<?> createCourse() {
		...
		case "일반인" -> {
			...
			yield newCouse.createCourse(name, newCouse); // Course<Person>
		}
		case "직장인" -> {
			Course<Worker> newCouse = new Course<Worker>();
			yield newCouse.createWorkerCourse(name, newCouse); // Course<? super Worker>
		}
		case "학생" -> {
			Course<Student> newCouse = new Course<Student>();
			yield newCouse.createStudentCourse(name, newCouse); // Course<? extends Student>
		}
