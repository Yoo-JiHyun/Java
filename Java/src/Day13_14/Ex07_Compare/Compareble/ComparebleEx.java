package Day13_14.Ex07_Compare.Compareble;
...
/**
 * 책(Book)을 가격순으로 오른차순 정렬 1. Comparable 인터페이스 구현 2. compareTo() 메소드 오버라이딩 -
 * 비교기준에 따라 양수, 0, 음수 반환 3. Collections.sort() 메소드로 정렬
 */
class Book implements Comparable<Book> {
	...
	/**
	 * compareTo() - 해당 객체 this와 비교 객체 o의 크기기준을 설정하여 반환메소드 return 양수(1) : 해당객체 >
	 * 비교객체 0 : 해당객체 = 비교객체 음수(-1) : 해당객체 < 비교객
	 */
