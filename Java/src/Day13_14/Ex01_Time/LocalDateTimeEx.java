...
public class LocalDateTimeEx {
	...
	public static void main(String[] args) {
		...
		// 2025년 2월 10일 19시 20분 0초
		LocalDateTime endDateTime = LocalDateTime.of(2025, 2, 10, 18, 20, 0);
		System.out.println("종강 : " + endDateTime);

		// A.insBefore(B) : A가 B보다 이전이면, true 아니면 false
		// A.insEqual(B) : A가 B이랑 같으면, true 아니면 false
		// A.insAfter(B) : A가 B보다 이후이면, true 아니면 false
		if (todayDateTime.isBefore(endDateTime)) {
			System.out.println("교육과정 진행 중 입니다.");
